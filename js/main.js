...
(function(){
  ...
  if(hero){
    ...
    hero.querySelectorAll('.hc-line > span').forEach(function(sp){
      ...
      if(shine) sp.classList.remove('hc-shine'); /* parent clip breaks with split letters; letters carry shine */
    ...
    function doLit(){ if(lit) return; lit = true; title.classList.add('lit'); }
